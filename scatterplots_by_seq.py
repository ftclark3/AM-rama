...
import matplotlib; matplotlib.use('Agg'); import matplotlib.pyplot as plt
                      # causes new Axes to be initialized in each subprocess so that we don't mix our plots together
...
def loop_interior(a1, a2, a3):
    rulisek_path = f'rulisek_tripeptide/extracted_info/{a1}{a2}{a3}.npy' 
        # these have shape (num_conformers, 7), where the energy is column 0, phi is column 4, and psi is column 5
    wales_path = f'wales_tripeptide/analysis/stats_by_seq/{one_to_three[a1]}{one_to_three[a2]}{one_to_three[a3]}.npy' 
    ...
    plt.title(f"Rulisek vs. Wales\nDihedrals and Energies, {a1}{a2}{a3}")
    plt.savefig(f'database_comparison/{a1}{a2}{a3}.png',bbox_inches='tight')
    plt.close()
